...
class FeedBack(models.Model):
    ...
    is_installable = models.BooleanField(choices=RADIO_CHOICES, default=None)
    installable_description = models.TextField()
    is_UI_intuitive = models.BooleanField(choices=RADIO_CHOICES, default=None)
    intuitive_description = models.TextField()
    are_features_clear = models.BooleanField(
        choices=RADIO_CHOICES, default=None)
    features_description = models.TextField()
    are_expectations_met = models.BooleanField(
        choices=RADIO_CHOICES, default=None)
    expectations_descriptions = models.TextField()
    is_bug_free = models.BooleanField(choices=RADIO_CHOICES, default=None)
    bug_description = models.TextField()
    is_quick = models.BooleanField(choices=RADIO_CHOICES, default=None)
