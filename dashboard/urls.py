...
urlpatterns = [
    ...
    path('single-hospital/<int:hospital_id>',
         views.singleHospital, name="single-hospital"),
    ...
    path('single-hospital/<int:hospital_id>/measures',
         views.measuresView, name='single-hospital-measures'),


    # fetching data url
    path('measures_data/', views.measures_data, name='measures_data'),
    path('get_measures_data/', get_measures_data, name='get_measures_data'),
